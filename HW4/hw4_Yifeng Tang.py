...
## rename the column, change the headers:
...
## rename the column to the simpler names (easy to show in plots)
...
# readin states name (for Choropleth map)
...
# read in state codes for Choropleth map
code = {'Alabama': 'AL',
        'Alaska': 'AK',
        'Arizona': 'AZ',
        'Arkansas': 'AR',
...
# subtitle"
    ...
    # plots pie_chart & bar_plot
     ...
     # two bar_plots, engineering vs science
...
#define the drop down call back (the drop_down of the first histogram)
...
#define the drop down call back (the drop_down of the second pie_chart and bar_plot)
